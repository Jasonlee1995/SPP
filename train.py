...
class ZFNet_SPP():
    def __init__(self, pyramids=[4, 3, 2, 1], num_classes=1000, gpu_id=0, print_freq=10, epoch_print=10):
        ...
        self.model = model.ZFNet_SPP(self.pyramids, self.num_classes).cuda(self.gpu)
